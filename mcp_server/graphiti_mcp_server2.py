...
# Dictionary to store task references to prevent garbage collection
queue_worker_tasks: dict[str, asyncio.Task] = {}
...
async def process_episode_queue(group_id: str):
    ...
    """
    global queue_workers, queue_worker_tasks
    ...
    try:
        ...
        if group_id in queue_worker_tasks:
            del queue_worker_tasks[group_id]
...
async def add_memory(
    ...
    """
    global graphiti_client, episode_queues, queue_workers, queue_worker_tasks
    ...
    try:
        ...
        if not queue_workers.get(group_id_str, False):
            ...
            queue_worker_tasks[group_id_str] = task
